    ...
    return (
        <div className='container px-lg-5 px-md-5'>
            ...
            <div className='row mt-2 pt-2'>
                ...
                <div className='col-lg col-md align-self-center mt-4 mt-lg-0 mt-md-0' data-aos="fade-up-left" data-aos-duration="2000">
            ...
            <div className='row pt-5 mt-5'>
                <div className='col-lg col-md d-lg-none d-sm-block d-print-block'data-aos="fade-up-left" data-aos-duration="2000" >
                    <div className='px-lg-5 px-md-0'>
                ...
                <div className='col-lg col-md align-self-center mt-5 mt-md-0 mt-lg-0' data-aos="fade-up-right" data-aos-duration="2000" >
                    <h1 className='display-5 fw-bold'>{props.head1}</h1>
                    <p className='fs-5 pt-2'>{props.par3}</p>
                    <p className='fs-5'>{props.par4}</p>
                </div>
                <div className='col-lg col-md d-none d-lg-block d-print-block' data-aos="fade-up-left" data-aos-duration="2000">
                    <div className='px-lg-5 px-md-0'>
                        {/* Lazy loading for images in props.col2 */}
                        <LazyLoad height={200} offset={100}>
                            {props.col2}
            ...
            <div className='row mt-5 pt-5' data-aos="fade-up-right" data-aos-duration="2000">
                ...
                <div className='col-lg col-md align-self-center' data-aos="fade-up-left" data-aos-duration="2000">
